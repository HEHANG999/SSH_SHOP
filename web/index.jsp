...
<html>
  ...
  <body>
  	<div class="wrapper">
	        ...
	        <div class="top_bar clear">
              <!--头部小导航-->
               ...
               <ul class="top_links fr">
                 ...
                 <li><a href="send_main_aIndex.action">我的账户</a></li>
                 <li><a href="#">购物车</a></li>
                 <li><a href="#">注册</a></li>
                 <li ><a href="#">登录</a></li>
               </ul>
	           ...
	           <div class="minicart">
	             <a class="minicart_link" href="#">
	                <span class="item"><b>2</b>件/</span>
	                <span class="price"><b>￥199.80</b></span>
	             </a>
	           </div>
		       <!-- 购物车结束 -->
		       <!-- 搜索框 -->
        ...
        <!-- 产品列表 -->
        <c:forEach items="${applicationScope.bigList}" var="list"><!-- 大循环拿到bigList -->
          <div class="products_list products_slider clear">
            <h2 class="sub_title">${list[0].categoryEntity.type}</h2><!-- 商品所属类别名称 -->
            <ul id="first-carousel" class="first-and-second-carousel jcarousel-skin-tango">
              <c:forEach items="${list }" var="product"><!-- 小循环显示具体商品 -->
               <li>
                  ...
                  <div class="price_info"> 
                    <a href="${shop}/item_addItem.action?productEntity.id=${product.id}"><button><span class="pr_add">添加购物车</span></button></a>
